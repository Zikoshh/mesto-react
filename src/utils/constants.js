...
const buttonSubmitPopupProfile = formPopupProfile.querySelector('.popup__submit');
const inputUserName = formPopupProfile.querySelector('.popup__input_user-name');
const inputAboutUser = formPopupProfile.querySelector('.popup__input_about-user');
